...
function toggleClass() {
  ...
  if (navMenuBtn.getAttribute("src") === "./images/icons/hamburger-md.svg") {
    navMenuBtn.setAttribute("src", "./images/icons/cross.svg");
  } else {
    navMenuBtn.setAttribute("src", "./images/icons/hamburger-md.svg");
  }
}

navMenuBtn.addEventListener("click", toggleClass);
